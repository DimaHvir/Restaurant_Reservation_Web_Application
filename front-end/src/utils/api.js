...
export async function makeReservation(newReservation, signal) {
    const url = new URL(`${API_BASE_URL}/reservations`);
    const options = {
	method: "POST",
	headers,
...
export async function makeTable(newTable, signal) {
    const url = new URL(`${API_BASE_URL}/tables`);
    const options = {
	method: "POST", 
	headers,
...
export async function seatTable(tableId, reservationId, signal) {
    ...
    return await fetchJson(url, options, reservationId);
}
...
export async function updateReservation(reservationId, params, signal) {
