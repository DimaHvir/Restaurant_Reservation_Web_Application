...
function SeatReservation() {
	...
	if (table.capacity >= reservation.people && !table.reservation_id) {
	    return (<option key={table.table_id} id={table.table_id} value={table.table_id}>{table.table_name} - {table.capacity}</option>);
	}
    });
    ...
    return (<main>
		...
		<div className="d-md-flex bm-3">
			...
			<select name="table" id="select_table" required>
			    {options}
			</select>
